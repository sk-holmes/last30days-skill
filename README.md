...
| **Perplexity** | Controlled Agent API synthesis, raw Search API rows, and explicit Deep Research. |
...
| Perplexity Agent API / Search API / Deep Research | Perplexity key | Pay as you go; Deep Research is an explicit background run |
