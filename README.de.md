...
| **Perplexity** | Gesteuerte Agent-API-Synthese, Rohtreffer der Search API und explizite Deep Research. |
...
| Perplexity Agent API / Search API / Deep Research | Ein Perplexity-Schlüssel | Nutzungsabhängig; Deep Research ist ein expliziter Hintergrundlauf |
