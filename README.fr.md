...
| **Perplexity** | Une synthèse contrôlée avec l’Agent API, les résultats bruts de la Search API et Deep Research explicite. |
...
| Perplexity Agent API / Search API / Deep Research | Une clé Perplexity | Paiement à l'usage ; Deep Research est une exécution explicite en arrière-plan |
