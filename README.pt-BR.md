...
| **Perplexity** | Síntese controlada da Agent API, resultados brutos da Search API e Deep Research explícito. |
...
| Perplexity Agent API / Search API / Deep Research | Uma chave do Perplexity | Pagamento por uso; Deep Research é uma execução explícita em segundo plano |
