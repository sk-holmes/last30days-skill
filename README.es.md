...
| **Perplexity** | Síntesis controlada con la Agent API, resultados en bruto de la Search API y Deep Research explícita. |
...
| Perplexity Agent API / Search API / Deep Research | Una clave de Perplexity | Pago por uso; Deep Research es una ejecución explícita en segundo plano |
