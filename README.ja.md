...
| **Perplexity** | 制御された Agent API の統合、Search API の生の結果、明示的な Deep Research。 |
...
| Perplexity Agent API / Search API / Deep Research | Perplexity のキー | 従量課金。Deep Research は明示的なバックグラウンド実行です |
